...
import com.example.chatyou.databinding.ActivitySingUpBinding;
                ...
                auth.createUserWithEmailAndPassword(binding.Email.getText().toString(), binding.Password.getText().toString()).
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if(task.isSuccessful())
                        {
                            ...
                            Toast.makeText(SingUp.this, "User Created Successfull", Toast.LENGTH_SHORT).show();

                            Intent i = new Intent(SingUp.this, sing_in.class);
                            startActivity(i);
                        }
                        else
                        {
